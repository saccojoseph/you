...
export const people: Person[] = [
  { id: "jennifer", name: "Jennifer", relation: "Wife", importance: "Inner circle", initials: "JE", color: "peach", lastContact: "Today", nextMoment: "Anniversary · Oct 17", details: "Loves the coast, live music, and unhurried weekends." },
  ...
  { id: "sarah", name: "Sarah Thompson", relation: "Mike’s wife · Friend", importance: "Close", initials: "ST", color: "lilac", lastContact: "Sep 12", details: "Started a new role at Pfizer. Emma is her daughter." },
...
export const memories: Memory[] = [
  { id: "m-jenn-coast", subjectId: "jennifer", category: "Preferences", label: "Enjoys Newport weekends", value: "Jennifer mentioned Newport as a place she wants to revisit.", status: "known", confidence: 0.95, source: "Conversation note", sourceType: "user", observedAt: "2026-06-12", lastVerified: "2026-06-12", evidence: "You saved: “Jen keeps talking about the little inn in Newport.”", privacy: "available" },
  { id: "m-jenn-gift", subjectId: "jennifer", category: "Preferences", label: "Gift idea", value: "A weekend at the coast", status: "known", confidence: 1, source: "You", sourceType: "user", observedAt: "2026-08-04", lastVerified: "2026-08-04", evidence: "You explicitly saved this gift idea.", privacy: "available" },
  { id: "m-anniversary", subjectId: "jennifer", category: "People", label: "Wedding anniversary", value: "October 17", status: "known", confidence: 1, source: "You", sourceType: "user", observedAt: "2026-01-08", lastVerified: "2026-01-08", evidence: "You entered your anniversary during setup.", privacy: "available" },
